...
vignette in machines that do not have DIAMOND installed. 
...
[^3]: **Friendly tip:** `r BiocStyle::Biocpkg("syntenet")` uses the *Infomap* algorithm
...
the function `stats::dist()` with parameter `method = "euclidean"`.
